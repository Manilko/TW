...
final class FurnitureViewController: UIViewController {
    ...
    var yourDataModel: YourDataModel = YourDataModel()
    ...
    @objc private func firstButtonTapped() {
        ...
        yourDataModel = YourDataModel()
        RealmManager.shared.add(yourDataModel)
    }
