...
final class HouseIdeaDetailView: UIView {
    ...
    lazy var detailModsView: DetailHouseIdeaView = {
        let view = DetailHouseIdeaView()
    ...
    init(isFavorite: Bool) {
        ...
        navView = NavigationView(leftButtonType: .leftArrow, title: "House Idea", rightButtonType: rightButtonType)
