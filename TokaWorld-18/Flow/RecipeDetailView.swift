...
final class RecipeDetailView: UIView {
    ...
    lazy var detailModsView: DetailRecipeView = {
        let view = DetailRecipeView()
...
//    }()
    ...
    init(isFavorite: Bool) {
        ...
        navView = NavigationView(leftButtonType: .leftArrow, title: "Recipe", rightButtonType: rightButtonType)
