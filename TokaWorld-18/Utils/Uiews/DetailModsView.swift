...
class DetailFurnitureView: UIView {
    ...
    func configure(with model: FurnitureElement) {
        imageView.image = .getImageFromFile(fileName: "/Furniture/\(model.rd1Lf2 ?? "" )")
        nameLabel.text = model.rd1Ld4
        descriptionLabel.text = model.rd1Li1
    }
...
class DetailGuideView: UIView {
    ...
    func configure(with model: Guide) {
        imageView.image = .getImageFromFile(fileName: "/Guides/\(model.rd1Lf2 ?? "" )")
        nameLabel.text = model.rd1Ld4
        descriptionLabel.text = model.rd1Li1
    }
...
class DetailRecipeView: UIView {
    ...
    func configure(with model: Recipe) {
        imageView.image = .getImageFromFile(fileName: "/Recipes/\(model.rd1Lf2 ?? "" )")
        nameLabel.text = model.rd1Ld4
        descriptionLabel.text = model.rd1Li1
    }
...
class DetailHouseIdeaView: UIView {
    ...
    func configure(with model: HouseIdea) {
        imageView.image = .getImageFromFile(fileName: "/House_Ideas/\(model.rd1Lf2 ?? "" )")
        nameLabel.text = model.rd1Ld4
        descriptionLabel.text = model.rd1Li1
    }
